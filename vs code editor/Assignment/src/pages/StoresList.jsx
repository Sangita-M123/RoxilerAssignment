...
//         const res = await axios.get(`${BACKEND_URL}/api/stores?query=${query}`, {
...
//             <div>
//               <Link to={`/stores/${s.id}`} className="text-lg font-semibold">{s.name}</Link>
//               <div className="text-sm text-gray-600">{s.address}</div>
//               <div className="mt-2 flex items-center gap-2">
//                 <RatingStars value={s.rating_avg} readonly />
//                 <span className="text-sm text-gray-600">{s.rating_avg} ({s.rating_count})</span>
//               </div>
//             </div>
//             <div className="text-right">
//               <div className="text-sm">Your rating</div>
//               <div className="mt-2"><Link to={`/stores/${s.id}`} className="text-blue-600">Rate / View</Link></div>
//             </div>
//           </div>
//         ))}
//       </div>
...
// Call fetchStores after rating or periodically


  // Fetch stores when component mounts or query changes
